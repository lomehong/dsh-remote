...
function RemoteTab({ t }) {
  ...
  const [checkBusy, setCheckBusy] = (0, import_react.useState)(false);
  const [applyBusy, setApplyBusy] = (0, import_react.useState)(false);
  const [applyError, setApplyError] = (0, import_react.useState)("");
  const runCheck = (0, import_react.useCallback)(async () => {
    setCheckBusy(true);
    setApplyError("");
    try {
      setUpdateInfo(await api("/dsh-remote/api/update/check"));
    } catch (err) {
      setUpdateInfo(null);
  ...
  const runApply = (0, import_react.useCallback)(async (tag) => {
    setApplyBusy(true);
    setApplyError("");
    try {
      ...
      for (; ; ) {
        ...
        const st = await api("/dsh-remote/api/update/check");
        setUpdateInfo(st);
        if (!st.applying) {
  ...
  const updateSection = (() => {
    ...
    if (updateInfo.checkError !== void 0 && updateInfo.checkError !== "") {
      return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { style: { ...s.hint, color: c.danger }, children: [
        t("checkFailed"),
        "\uFF1A",
    ...
    if (updateInfo.pendingVersion !== null) {
      return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { style: { ...s.hint, color: c.success }, children: [
        t("appliedPending"),
        "\uFF08",
        updateInfo.pendingVersion,
        "\uFF09"
      ] });
    }
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: s.row, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "button",
          {
            ...
            onClick: () => {
              void runApply(updateInfo.latest);
            },
            children: applyBusy || updateInfo.applying ? t("applying") : `${t("updateTo")} ${updateInfo.latest}`
          }
        )
      ] });
    }
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { style: s.hint, children: t("upToDate") });
  })();
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: s.root, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: s.section, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", { style: s.sectionTitle, children: t("update") }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: s.row, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: s.badge, children: [
          t("currentVersion"),
          ": ",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { style: s.button, disabled: checkBusy || applyBusy, onClick: () => {
          void runCheck();
        }, children: checkBusy ? t("checking") : t("checkUpdate") })
      ] }),
      updateSection,
      applyError !== "" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { style: { ...s.hint, color: c.danger }, children: applyError }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { style: s.hint, children: t("updateHint") })
    ] })
  ] });
}
